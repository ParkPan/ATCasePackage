...
recorddate = '20160514' #it's a partition of odps tables, the date that you want to test data
recordmonth = '201605'  #it's a partition of odps tables(part), the month that you want to test data

folderpath = r'D:\gitRepo\platform' #project folder path to compile
...
workpath = r'd:\gitRepo\platform\whale\release\target\target-1.0.1-whale'   #running odps job path, the work path for AUT.
...
FiveMinutePeakBandWidthJob={'name':'FiveMinuteBandWidth','outputtable':'output_bandwidth_every_five_minute','mysqltable':'ops_bandwidth_every_five_minute'}
