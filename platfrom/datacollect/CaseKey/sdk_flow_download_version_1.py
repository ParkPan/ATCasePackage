...
def sendlog():
    prefix = "/sdk/flow/download/version/1"
    ...
    body_data = GlobalVars.SDK_REPORT.sdk_flow_download_version_1
    ...
    for i in range(10):
        ...
        body_data['downloads'][0]['flow'][0]['timestamp'] = Action.GetTimeStamp.get_timestamp_now()
