...
def sendlog():
    prefix = "/sdk/flow/upload/version/1"
    ...
    body_data = GlobalVars.SDK_REPORT.sdk_flow_upload_version_1
    ...
    for i in range(10):
        ...
        body_data['upload'][0]['timestamp'] = Action.GetTimeStamp.get_timestamp_now()
