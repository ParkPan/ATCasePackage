...
def makeexpecteddata(hour=-1):
    ...
    resultfile = open(os.path.abspath(os.path.dirname(__file__)) + '/../testdata/PeerInfoCleaned.txt', 'r')
    ...
    expectedfile = open(os.path.abspath(os.path.dirname(__file__)) + "/../inputdata/%sISP.txt"%__name__.split('.')[-1],"w")
    ...
    expectedfile = open(os.path.abspath(os.path.dirname(__file__)) + "/../inputdata/%sProvince.txt"%__name__.split('.')[-1],"w")
