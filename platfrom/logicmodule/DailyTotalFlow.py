...
def makeexpecteddata(hour=-1):
    ...
    resultfile = open(os.path.abspath(os.path.dirname(__file__)) + '/../testdata/UploadFlowCleaned.txt', 'r')
    ...
    for line in orgdownlines:
        ...
        resultlist[tmpusername][playtype]['cdndown'] = resultlist[tmpusername][playtype].setdefault(
    ...
    for line in orguplines:
        ...
        if playtype not in totallist:
            totallist[playtype] = {}
        resultlist[tmpusername][playtype]['upload'] = resultlist[tmpusername][playtype].setdefault(
