...
def makeexpecteddata(hour=-1):
    resultfile = open(os.path.abspath(os.path.dirname(__file__)) + '/../outputdata/DailySeekTimeCountDB.txt', 'r')
    orglines = resultfile.readlines()
    resultfile.close()

    tempfile1 = open(os.path.abspath(os.path.dirname(__file__)) + '/../outputdata/DailySeekTimeCountDBWeek1.txt', 'w')
    ...
    tempfile2 = open(os.path.abspath(os.path.dirname(__file__)) + '/../outputdata/DailySeekTimeCountDBWeek2.txt', 'w')
    for line in orglines:
        tmpstr = line.split(',')[1]
        tmpcount = line.split(',')[2]
        if int(tmpstr) < 3000:
    ...
    resultfile1 = open(os.path.abspath(os.path.dirname(__file__)) + '/../outputdata/DailySeekTimeCountDBWeek1.txt', 'r')
    orglines1 = resultfile1.readlines()
    resultfile1.close()

    resultfile2 = open(os.path.abspath(os.path.dirname(__file__)) + '/../outputdata/DailySeekTimeCountDBWeek2.txt', 'r')
