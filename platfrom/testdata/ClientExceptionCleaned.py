...
class ClientExceptionCleaned(dataprovider.Dataprovider):

    tablename = 'input_client_exception_cleaned'
    ...
    def makedata(self):
        ...
        with open(os.path.abspath(os.path.dirname(__file__)) + '/ClientExceptionCleaned.txt', 'w') as filedemanddata:
            for i in range(24):
                for j in range(60):
        ...
        return os.path.abspath(os.path.dirname(__file__)) + '/ClientExceptionCleaned.txt'
